...
class Graphic(solve):
    def __init__(self):
        # Initialiser la classe de résolution (solve)
        solve.__init__(self)
    ...
    def element(self):
        ...
        self.button_solve = self.button_hover("resolution", 400, 500, 150, 100, self.white, self.pal4, self.pal4, "solve", self.font, self.black, 25, 0, 5)
